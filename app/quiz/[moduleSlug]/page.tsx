  ...
  return (
    <AppShell role="student">
      <div className="space-y-6">
        ...
        <div>
          <h1 className="text-4xl font-black text-pop-ink">Контрольный тест</h1>
          <p className="mt-2 text-muted-foreground">Проверь знания по модулю.</p>
        </div>
        {data.attempts[0] ? (
          <Card>
            <CardContent className="flex flex-wrap gap-3 p-6 text-sm text-muted-foreground">
              ...
              <span>{data.attempts[0].passed ? "Тест пройден" : "Есть что улучшить"}</span>
            </CardContent>
          </Card>
        ) : null}
        <QuizRunner
